                ...
                while (untouched)
                {
                    ...
                    if (untouched == false)
                    {
                        ...
                        for (int k = 0; k < CoreCurves.Count; k++)
                        {
                            ...
                            Point3d PP0 = C0.PointAtLength(dia);

                            if (PP0.DistanceTo(C0.PointAtStart) < Pti1.DistanceTo(C0.PointAtStart) && Pti1.DistanceTo(Pti2) < dia + dia / 2.0)
                            {
                                Selfintersect = true;
                                break;
                ...
                while (untouched)
                {
                    ...
                    while (Valid == false)
                    {
                        ...
                        for (int k = 0; k < CoreCurves.Count; k++)
                        {
                            ...
                            if (PP0.DistanceTo(C.PointAtStart) < Pti1.DistanceTo(C.PointAtStart) && Pti1.DistanceTo(Pti2) < dia + dia / 2.0)
                            {
                                Selfintersect = true;
                                break;
